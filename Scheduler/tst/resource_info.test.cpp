...
namespace {
	...
	TEST(ResourceInfoComparison, GreaterThan) {
	...
	TEST(ResourceInfoComparison, LessOrEqual) {
	...
	TEST(ResourceInfoComparison, GreaterOrEqual) {
	...
	TEST(ResourceInfoComparison, ComparisonMisc) {
